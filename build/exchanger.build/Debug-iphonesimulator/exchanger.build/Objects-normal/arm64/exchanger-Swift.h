...
#ifndef EXCHANGER_SWIFT_H
#define EXCHANGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="exchanger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9exchanger11AppDelegate")
...
SWIFT_CLASS("_TtC9exchanger13SceneDelegate")
...
SWIFT_CLASS("_TtC9exchanger14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(exchanger)) <UIPickerViewDelegate>
- (NSString * _Nullable)pickerView:(UIPickerView * _Nonnull)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
- (void)pickerView:(UIPickerView * _Nonnull)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component;
@end


@interface ViewController (SWIFT_EXTENSION(exchanger)) <UIPickerViewDataSource>
